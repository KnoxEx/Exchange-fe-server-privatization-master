(() => {
  ...
  class HeaderExtend {
    init() {
      ...
      this.$headerIsLoginNavEvenTitle = document.querySelectorAll('.header-isLogin-navEven-title');
      ...
      this.headerNavEvenListIn = this.$commonHeader.querySelectorAll('.header-navEven-list');
