(() => {
  ...
  class RecommendExtend {
    init() {
      ...
      if (this.$recommend.querySelectorAll('.cloned').length) {
        this.$recommendContent = this.$recommend.querySelectorAll('.recommend-content');
    ...
    resloveRecommendData(data) {
      ...
      this.$recommendContent.forEach((item, index) => {
        ...
        if (this.dataList[coinC]) {
          ...
          const recommendTimeNVal = `24H Vol ${this.dataList[coinC].vol ? this.dataList[coinC].vol : ''}`;
