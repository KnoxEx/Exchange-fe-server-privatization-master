import { imgMap, callApp } from '@/utils';
import livePhotos from '@/assets/images/1/livePhoto.png';
import countryMinix from '../../../../PC/common-mixin/countryList/countryList';

const idUpload1 = imgMap.kyc_idcard_a;
const idUpload2 = imgMap.kyc_idcard_b;
const idUpload3 = imgMap.kyc_idcard_c;
const idUpload4 = imgMap.livePhoto || livePhotos;
...
export default {
  ...
  computed: {
    ...
    bg1() {
      return {
        backgroundImage: `url(${idUpload1})`,
      };
    },
    bg2() {
      return {
        backgroundImage: `url(${idUpload2})`,
      };
    },
    bg3() {
      return {
        backgroundImage: `url(${idUpload3})`,
      };
    },
    bg4() {
      return {
        backgroundImage: `url(${idUpload4})`,
      };
    },
    authRealname() {
