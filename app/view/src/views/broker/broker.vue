...
<script>
import mixin from 'blockchain-ui-privatization/PC/common-mixin/broker/broker/broker';
import 'blockchain-ui-privatization/PC/common-mixin/broker/broker/broker.styl';
