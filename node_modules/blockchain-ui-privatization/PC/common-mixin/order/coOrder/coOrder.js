    ...
    columns() {
      ...
      if (this.nowType === 1) {
        list = [
          ...
          { title: this.$t('order.coOrder.nowList2'), width: '10%', align: 'left' }, // 合约
          ...
          { title: this.$t('order.coOrder.nowList11'), width: '10%' }, // 操作
        ];
      } if (this.nowType === 2) {
        list = [
          { title: this.$t('order.coOrder.hisList1'), width: '100px' }, // 时间
          { title: this.$t('order.coOrder.hisList2'), width: '10%', align: 'left' }, // 合约
